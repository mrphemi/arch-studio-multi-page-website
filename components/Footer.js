...
export default function Footer() {
  return (
    <footer className="bg-very-light-grey mt-[132px] pb-12">
      {/* Logo */}
      <div className="bg-very-dark-blue w-[120px] h-[120px] flex justify-center items-center mx-auto relative -top-14">
      ...
      {/* Links */}
      <ul className="space-y-8 mx-auto grid justify-center text-center">
        <li>
          <Link href="/portfolio">
            <a className="capitalize text-medium-grey">portfolio</a>
          </Link>
        </li>
        <li>
          <Link href="/about">
            <a className="capitalize text-medium-grey">about us</a>
          </Link>
        </li>
        <li>
          <Link href="/contact">
            <a className="capitalize text-medium-grey">contact</a>
          </Link>
        </li>
        <Button
